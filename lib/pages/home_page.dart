...
class _HomePageState extends State<HomePage> {
  ...
  // ESTA FUNCION SE USA PARA BUSCAR EN TODA LA BASE
  ...
  void initState() {
    super.initState();
    _refreshJournals(); // CARGA LAS JORNADAS CUANDO SE INICIA
  }
...
// Insertar una nueva revista en la base de datos
  ...
  void _deleteItem(int id) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
      content: Text('Elemento Borrado con exito'),
    ));
    _refreshJournals();
  }
